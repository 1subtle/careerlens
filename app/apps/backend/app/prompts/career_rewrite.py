    ...
    return json.dumps(
        {
            ...
            "编辑准则": [
                ...
                "用户购买的是直接改写服务。draft 必须给出可直接放进简历的改写正文，不能原样返回，"
                "不能只给建议或以缺少补充信息为由停止编辑。即使原文清楚，也应优化叙述顺序、"
                "句式或信息组织；以实际行动为核心，把研究对象、方法和已有成果组织成完整句子。"
                "例如‘通过问卷、爬虫等方式，调研某产品体验与消费意愿’可改为"
                "‘围绕某产品体验与消费意愿开展调研，采用问卷调查与爬虫采集相关数据。’",
